...
| **Toa 1+11** | 📦 Asset Summary | 05:48 & 15:48 MMT | **Ghế R3.1**: Báo cáo tiến độ vật tư Asset (`3.1 Asset progress for material`) | `cron_send.py` (`build_asset_msg`) | Bot API Tokens $\rightarrow$ Telegram Groups | Tin nhắn riêng tổng hợp tiến độ xuất/nhập/vận chuyển vật tư Asset cho Control Site & 4 Teams |
