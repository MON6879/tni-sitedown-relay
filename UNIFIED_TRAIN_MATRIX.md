...
| **Toa 12** | 🕵️ Ingestion Auditor (Ghế 9.1) | **01:03 AM MMT** | Giám sát thu thập dữ liệu & ảnh Telegram $\rightarrow$ Google Sheet. Báo lỗi về Group 9.1 | `ingestion_auditor.py` | Search Bot / Telethon $\rightarrow$ Group `9 TNI REQUEST REFUEL` | Phát cảnh báo Tên Sheet / Tab không thu thập được thông tin |
