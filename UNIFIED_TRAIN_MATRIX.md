...
| **ĐỘC LẬP** | 🚨 Site Down Relay | Phút `:06` & `:36` hàng giờ (Ví dụ: 11:06, 11:36, 12:06, 12:36, 13:06, 13:36, 14:06, 14:36...) | Cào tin trạm sập NOC Pro | `botlookup_relay.yml` + `train_5min.yml` | Telethon `@Phongha79` $\rightarrow$ Sheet Site Down Row 2 | Cào tin trạm sập NOC Pro $\rightarrow$ Bắn cảnh báo Telegram tự động |
